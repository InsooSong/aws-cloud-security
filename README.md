...
- [x] Day 5 — IAM Security Best Practices

## Phase 2 — AWS Networking

- [x] Day 6 — VPC Fundamentals
- [x] Day 7 — Public & Private Subnets
- [x] Day 8 — Route Tables & Internet Gateway
- [ ] Day 9 — NAT Gateway
...
Day 6 will focus on Amazon VPC fundamentals.
...
Day 7 will focus on Public and Private Subnets.
...
- Subnet-level security considerations
- Practical subnet architecture examples
...
Day 8 will focus on Route Tables and Internet Gateways.
...
An Internet Gateway (IGW) is a horizontally scaled AWS-managed VPC component that provides connectivity between a VPC and the Internet.
...
Day 9 will focus on NAT Gateway.
...
- VPC endpoints as an alternative for some AWS service traffic
